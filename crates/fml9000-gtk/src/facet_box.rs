...
pub fn load_playlist_store<'a, I>(vals: I, store: &ListStore)
where
...
pub fn load_facet_store(rows: &[Arc<Track>], facet_store: &ListStore) {
  let facets = fml9000_core::build_facets(rows);
  for facet in facets {
